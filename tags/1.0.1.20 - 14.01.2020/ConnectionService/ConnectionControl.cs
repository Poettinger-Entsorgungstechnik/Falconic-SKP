...
//                _apiKey = _apiKeyDev;
        ...
        public void RemoveECOClient(SMSClientConnection client)
        {
            try
            {
                    ...
                    do
                    {
                        ...
                        if (tcpl.Pending())
                        {
                            ...
                            if (firstLineReceived.IndexOf("ECO-") != -1 || firstLineReceived.IndexOf("SMS-Remote") != -1 || firstLineReceived.IndexOf("BWASTE-") != -1)
                            {
                                ...
                                //if (firstLineReceived.IndexOf("SMS-Remote") == -1)
                                //{
                                ...
                                //            bIsInFalconic = true;
                                //        }
                                //        catch (Exception excp) { string x = excp.Message; };
                                //    }
                                //}
...
//                                    info.FirmwareType = FirmwareType.Presscontrol;
                                    ...
                                    {
                                        _numberOfStartingsLastCycle = (int)info.NumberOfStartings;
                                        _signalQualityLastCycle = (int)info.GsmSignalStrength;
                                        _cellInfoLastCycle = networkInfo;
...
//                            loc.IsWatchdogActive = (bool)location.LocationMonitoringActive;
                            ...
                            if ((bool)location.NightLockActive)
                            {
